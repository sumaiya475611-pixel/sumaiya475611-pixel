// ============================================================
// ✏️  lib/content.js  — PERSONALISE THE WEBSITE HERE
//     Change the name, age, and all on-screen text below.
// ============================================================

export const BIRTHDAY_NAME = 'Princess';   // ← change this
export const BIRTHDAY_AGE  = 3;            // ← change this
...
// Message shown after clicking "Make a Wish"
export const BIRTHDAY_WISH = 'May all your dreams come true, little princess! 💖';
